...
export default function Logo({ className }: LogoProps) {
  ...
  return (
    <div
      className={
        "group/logo relative flex h-14 w-14 items-center justify-center overflow-hidden rounded-xl border border-zinc-800 bg-black transition-shadow duration-300 hover:shadow-[0_0_16px_rgba(16,185,129,0.25)] " +
        (className ?? "")
      }
    >
      {isLoaded && (
